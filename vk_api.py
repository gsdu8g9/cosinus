...
class VkApi(object):
    def __init__(self, login=None, password=None, number=None, sec_number=None,
                 token=None, proxies=None,
                 auth_handler=None, captcha_handler=None,
                 api_version='5.62', app_id=5282063, scope=0b1111111111111111111111111111,
                 client_secret=None):
        """
    ...
    def authorization(self, reauth=False):
        ...
        if self.login and self.password:
            ...
            self.sid = self.settings.get("remixsid")
    ...
    def api_login(self):
        ...
        if not self.sid or not self.settings.get("forapilogin"):
        ...
        self.http.cookies.update(self.settings.get("forapilogin"))
