...
rasp_a = {
  "5383": [
    # Понедельник
    { (2,2): {"name": "Построение и анализ алгоритмов (лабы)",
              "class": "3402",
              "teacher": "Фирсов Михаил Александрович"},

      (3,0): {"name": "Объектно-ориентированное программирование (лабы)",
              "class": "3402",
              "teacher": "Жукова Наталья Александровна"},

      (4,0): {"name": "Построение и анализ алгоритмов (лекция)",
              "class": "5230",
    ...
    # Вторник
    { (3,1): {"name": "Объектно-ориентированное программирование (практика)",
              "class": "3402",
              "teacher": "Жукова Наталья Александровна"},

      (3,2): {"name": "Комплексный анализ (лекция)",
              "class": "3238",
              "teacher": "Коточигов Александр Михайлович"},

      (4,0): {"name": "Комплексный анализ (практика)",
              "class": "2414",
              "teacher": "Колпаков Андрей Сергеевич"},

      (5,0): {"name": "Физкультура",
              "class": "4 корпус",
              "teacher": ""},

      (6,0): {"name": "Организация производства и управление предприятием (лекция)",
              "class": "5423",
              "teacher": ""}},
    ...
    { (4,0): {"name": "Теория вероятности и мат. статистика (практика)",
      ...
      (5,0): {"name": "Теория вероятности и мат. статистика (лекция)",
              "class": "3324",
              "teacher": "Лифшиц Борис Анатольевич"},

      (6,0): {"name": "Иностранный язык",
              "class": "Кафедра иностранных языков",
              "teacher": ""}},

    # Четверг
    { (2,0): {"name": "Операционные системы (лекция)",
              "class": "3132",
              "teacher": "Губкин Александр Федорович"},

      (3,0): {"name": "Физкультура",
              "class": "4 корпус",
              "teacher": ""},

      (4,2): {"name": "Организация производства и управление предприятием (практика)",
              "class": "2421",
              "teacher": "Жернаков Антон Борисович"}},

    # Пятница
    { (3,0): {"name": "Операционные системы (лабы)",
              "class": "3402",
              "teacher": "Губкин Александр Федорович"},

      (4,0): {"name": "Объектно-ориентированное програмирование (лекция)",
              "class": "3132",
              "teacher": "Чередниченко Александр Иванович"}},
